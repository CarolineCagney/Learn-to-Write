...
// namespace for cococs so you dont have to use cocos2d:: every time 
...
public:
	...
	/*
	The following section is where all the sprites for this
	class are being initialised 
	The sprites incluse the letter sprite and the dots that
	are on the letter sprite
	Each dot is 
	*/
	Sprite* _i;
	Sprite* dot;
